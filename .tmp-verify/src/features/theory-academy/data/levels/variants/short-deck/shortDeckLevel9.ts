    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: 'example',
          content:
            '实例（翻前范围）：职业短牌玩家面对某 BB 3-bet 过多的对手，会收窄开池范围、减少被 3-bet 后只能弃牌的边缘牌；面对弃牌多的对手，会提高开池频率至接近 100%。这是"按对手倾向微调范围"的可计算决策，而非感觉。',
        },
        {
          type: 'example',
          content:
            '实例二（翻后范围分配）：职业短牌玩家在湿润面（9♦8♣6♥）会用 2/3 池以上大注保护超对，因为在短牌听牌密度高，小注给听牌太便宜。而在相对干燥面（K♠7♦J♣）用小注薄价值。短牌特有的"湿润面大尺度"是职业与业余的分水岭。',
        },
        {
          type: 'example',
          content:
      ...
      quiz: [
        ...
        },
        {
          ...
          question: '职业短牌玩家面对 3-bet 过多的对手，会如何调整翻前范围？',
          options: [
            '扩大开池',
            '收窄开池，减少被 3-bet 后只能弃牌的边缘牌',
            '完全停手',
            '无脑全下',
          ],
          correctIndex: 1,
          explanation: '面对 3-bet 过多的对手，边缘牌被 3-bet 后只能弃牌，应收窄开池范围。',
        },
        {
          id: 't9sd-case-study-q3',
          question: '职业短牌玩家在湿润面（9♦8♣6♥）持超对，正确做法是：',
          options: [
            '1/3 池小注',
            '2/3 池以上大注保护（短牌听牌密度高）',
            '过牌',
