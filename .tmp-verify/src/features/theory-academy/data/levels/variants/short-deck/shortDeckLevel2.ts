  ...
  chapters: [
    {
      ...
      content: [
        ...
        },
        {
          type: 'example',
          content:
            '实例：短牌底池 10 ante，你（BTN）持 A♥K♥，翻牌 9♥7♥6♣。对手下注 5 ante（半池），你跟注需 5，底池变 20。所需胜率 = 5/20 = 25%。你的同花听牌 5 outs（单街约 16%），加 A、K 高张共约 11 个综合 Outs，双街约 59%。25% 的赔率配 59% 的胜率，跟注 +EV；且成同花后是坚果级，隐含赔率极佳，甚至可以加注半诈唬。',
        },
        {
          type: 'example',
          content:
            '实例二（边缘跟注）：短牌底池 6 ante，你持 Q♠J♠，翻牌 9♣8♦6♥，你听 T 组成顺子（4 个 Outs，T 共 4 张）。对手下注 3 ante（半池），所需胜率 25%。你单街约 13%（4/31），双街约 25% 与所需胜率基本持平，且 T 成顺后可能压过对手两对。加隐含赔率后跟注转 +EV——短牌顺子听牌的隐含价值高。',
        },
        {
          type: 'highlight',
          content:
            '反直觉点：短牌底池大、赔率便宜，但"便宜"不等于"白给"。你必须用短牌修正后的胜率判断——同花 outs 只有 5 个，单街约 16%，看似不足以跟注，但成牌后是超强牌。把"赔率便宜"与"胜率修正"结合，才是短牌赔率的正确姿势。',
        },
        {
          type: 'pro-tip',
          content:
            '短牌赔率速算：半池下注所需胜率 25%、1/3 池 20%、满池 33.3%。背熟后结合"同花 5 outs ≈ 16% 单街、顺子 8 outs ≈ 26% 单街"判断是否够格。',
        },
      ],
      quiz: [
        {
        ...
        },
        {
          ...
          options: ['约 19%', '约 16%', '约 26%', '约 10%'],
          correctIndex: 1,
          explanation: '5 ÷ 31 ≈ 16%。19% 是满员桌 9 outs 的单街值，26% 是顺子 8 outs 的单街值。',
        },
        {
          id: 't2sd-potodds-q4',
        ...
        },
        {
          ...
          correctIndex: 1,
          explanation: '短牌顺子 8 outs 双街 1 − (23/31)×(22/30) ≈ 46%，远高于单街的 26%。',
        },
      ],
      variant,
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: 'example',
          content:
            '实例：短牌你持 7♥8♥，翻牌 9♦T♣K♠（两头顺听牌 8 个 Outs：6 和 J）。对手下注半池，你跟注 5 ante 看转牌。你的隐含赔率：若 6 或 J 让你成顺子（6-7-8-9-T 或 7-8-9-T-J），这是短牌强顺，可能压过对手的两对甚至三条以下。对手范围若有对子/强牌，成顺后能再赢 10+ ante。跟注的隐含赔率极佳。',
        },
        {
          type: 'example',
          content:
            '实例二（set mining 对比）：短牌你持 6♠6♦，翻前跟注 2 ante。翻牌 6♣9♥K♦，你中三条。表面看是大优势，但短牌中三条输给葫芦（对手持 99/K9）与同花。且对手范围里 99、K9 这类牌在短牌更常见（对子密度高）。所以即便中了三条，你也要警惕反超——这正是短牌 set 隐含赔率差的根源。',
        },
        {
          type: 'highlight',
          content:
      ...
      quiz: [
        ...
        },
        {
          ...
          options: ['约 12%', '约 17.1%', '约 25%', '约 8%'],
          correctIndex: 1,
          explanation: '短牌约 17.1%（1 − C(32,3)/C(34,3)，满员桌约 12%）。虽然击中概率更高，但三条价值下降，需更高门槛。',
        },
        {
          id: 't2sd-implied-q4',
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: 'example',
          content:
            '实例二（慢玩陷阱）：短牌你持 A♥A♣，翻牌 A♦9♥6♥，中三条 A。看似坚果，但短牌中三条 < 葫芦 < 同花，且牌面有同花听牌可能。若你慢玩过牌，对手用同花听牌免费追，转牌成同花反超你。短牌听牌密度高，强牌必须下注保护，避免慢玩带来的 RIO。',
        },
        {
          type: 'highlight',
          content:
