  ...
  chapters: [
    {
      ...
      objectives: [
        '理解短牌起手牌强度的根本重排：AK 与中小口袋对权益反转、AK 最强非对子',
      ...
      content: [
        ...
        {
          type: 'key-point',
          content: '短牌起手牌铁律：AA/KK 仍是顶级；AK 是"最强非对子"，翻前全下对中小口袋对约五五开甚至略优；口袋对靠中三条（约 17.1%）后的成牌强度立足。',
        },
        { type: 'heading', content: 'AK 与口袋对的短牌对比' },
        {
          type: 'formula',
          content:
            '短牌 AK 与口袋对的翻前全下对比（36 张牌组，精确枚举量级）：\n\nAK 对中小口袋对（66-QQ）：约 50%-56%（五五开甚至略优，AKs vs QQ ≈ 53.7%、AKo vs QQ ≈ 51.8%）\nAK 对 KK：约 32%-35%（KK 压制）\nAK 对 AA：约 28%-31%（严重落后）\nAK 对 AK（同牌）：约 50%（多为平分底池）\n\n口袋对价值提升原因：\n1. 短牌中三条 > 顺子，中三条后是极强成牌\n2. 对子密度高，翻牌中三条概率更高（约 17.1%）\n3. 满员桌 AK 对中小对子尚且落后，短牌反转为略优——对子的翻前权益优势消失，价值转向中三条后的成牌强度\n\nAK 的价值：仍是压制其他非对子的最强牌，且翻后能中顶对。（概念源自：《Short Deck Poker》起手牌强度与 6+ 规则；胜率为精确枚举量级）',
        },
        {
          type: 'text',
          content:
            '短牌起手牌重排的实践含义：翻前全下时，AK 对中小口袋对约五五开甚至略优——短牌的"翻硬币"方向与满员桌相反（满员桌 AK 对中小对子略落后）。同时，同花连牌（JTs、98s）因为顺子/同花成牌价值高，可玩性好，但属于次级梯队——它们能赢大锅（成坚果），但翻前强度不如对子与 AK。',
        },
        {
          type: 'example',
          content:
            '实例：短牌你持 A♠K♠，翻前对手 3-bet 全下。你的牌是"最强非对子"，面对中小口袋对（如 88）约 50%-55% 胜率（略优），但若对手范围含 AA/KK 则明显被压制。决策取决于底池赔率与对手范围：若范围以中小对子为主且只需约 45% 胜率，跟注 +EV；若范围含大量 AA/KK，谨慎弃牌。关键是用短牌修正后的胜率（AK vs 中小对子略优、vs AA/KK 落后）而非满员桌的单一直觉。',
        },
        {
          type: 'example',
          content:
            '实例二（小对子价值）：短牌你持 7♠7♦，翻前面对对手加注。短牌中 77 中三条概率约 17.1%（满员桌 12%），且三条是短牌强成牌（只输葫芦/同花）。所以小对子（66-99）在短牌中的价值显著提升——set mining 虽需更高门槛（T2），但中牌后的强度与频率都支持更多跟注。',
        },
        {
          type: 'highlight',
          content:
            '反直觉点：短牌中"AK 很强"需要正确理解。AK 压制所有非对子、翻后能中顶对；对中小口袋对约五五开偏上，仅对 AA/KK 明显落后。把满员桌"AK 对对子落后"的记忆搬进短牌，会误判 AK 的翻前价值。',
        },
        {
          type: 'pro-tip',
          content:
            '短牌起手速记：AA/KK 顶级、其他对子次之（三条价值高）、AK 最强非对子、同花连牌（JTs+）可玩性好但次级。翻前全下时，AK vs 中小对子用"五五开偏上"、对子 vs AA/KK 才明显落后——都别用满员桌直觉。',
        },
      ],
      quiz: [
        {
          ...
          options: ['约 46%', '约 54%', '约 70%', '约 35%'],
          correctIndex: 1,
          explanation: '精确枚举：短牌 AKs vs QQ ≈ 53.7%（AK 略优）；满员桌 AKs vs QQ ≈ 46%（落后）——"flip 反转"是短牌标志。',
        },
        {
          id: 't3sd-rankings-q2',
          ...
          options: [
            'AK 最强',
            'AK 对中小对子权益反转（由落后变略优），对子靠成牌价值立足',
            '同花连牌最强',
            '没有变化',
          ],
          correctIndex: 1,
          explanation: '短牌 AK 对 66-QQ 约五五开偏上（满员桌落后），"任何口袋对压制 AK"不成立；对子价值来自中三条（约 17.1%）后的成牌强度。',
        },
        {
          id: 't3sd-rankings-q3',
          question: '短牌中 AK 对 KK 的胜率约为：',
          options: ['约 15%', '约 33%', '约 55%', '约 70%'],
          correctIndex: 1,
          explanation: 'AK 对 KK 约 32%-35%（精确枚举量级），KK 压制 AK；满员桌约 30%，短牌因活牌更多略升。',
        },
        {
          id: 't3sd-rankings-q4',
          ...
          options: [
            '小对子更常见',
            '三条牌级上升且中三条概率更高（约 17.1%）',
            '小对子能成顺子',
            '没有原因',
          ],
          correctIndex: 1,
          explanation: '短牌三条 > 顺子，且中三条概率约 17.1%（满员桌 12%），小对子价值显著提升。',
        },
        {
          id: 't3sd-rankings-q5',
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: 'example',
          content:
            '实例：短牌你持 J♠T♠，翻前面对 BTN 加注。JTs 在短牌中可玩性好：翻牌能成同花听牌（价值高）、顺子听牌、或中顶对。虽然翻前强度不如对子，但翻后成牌潜力大。深筹码下应积极跟注或 3-bet 半诈唬，利用同花价值提升的隐含赔率。',
        },
        {
          type: 'example',
          content:
            '实例二（同花追注）：短牌你持 A♥9♥，翻牌 K♥8♦6♣。你听同花（已见 A♥9♥K♥ = 3 张红心，同花 outs = 9 − 3 = 6）。对手下注，你跟注。若转牌成红心，你的同花是坚果级（beats 葫芦），能榨取大量筹码。短牌同花听牌虽 outs 少（6 个），但成牌后价值极高，追注的隐含赔率极佳。',
        },
        {
          type: 'highlight',
          content:
        ...
        },
        {
          type: 'pro-tip',
          content:
            '短牌同花速记：同花 beats 葫芦 → 追同花听牌价值极高；JTs 及以上同花连牌可玩性好；同花 Ax 兼具坚果潜力与顶对。翻前遇到强阻力（大 3-bet）时，同花连牌应懂得收手——它们是投机牌。',
        },
      ],
      quiz: [
        {
        ...
        },
        {
          ...
          question: '短牌中 A♥9♥ 在 K♥8♦6♣ 面的同花 outs 为：',
          options: ['9', '6', '5', '4'],
          correctIndex: 1,
        ...
        },
        {
          ...
          question: '短牌同花连牌面对大 3-bet 时的正确态度是：',
          options: [
            '无脑跟注',
            '懂得收手，它们是投机牌',
            '永远全下',
          ...
          correctIndex: 1,
          explanation: '同花连牌是投机牌，面对大 3-bet 的强阻力应收手，不属顶级梯队。',
        },
      ],
      variant,
      variantRules: shortDeckRules,
    },
    {
      ...
      content: [
        ...
        },
        {
          type: 'example',
          content:
            '实例：短牌你在 BTN 持 7♠8♠，翻牌 9♦T♣A♥（两头顺听牌）。你 IP 下注或跟注都能便宜实现权益——转牌中 6/J 成顺，中不了可以免费看河牌或弃牌。若你在 BB（OOP）持同样牌，先行动、被加注时进退两难。位置让同一手听牌的价值完全不同。',
        },
        {
          type: 'example',
          content:
