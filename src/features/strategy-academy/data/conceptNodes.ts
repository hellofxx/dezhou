...
export const CONCEPT_NODES: ConceptNode[] = [
  ...
  },
  {
    ...
    relatedLessons: ['l4-range-thinking', 'l2-3bet-basics'],
    relatedModules: ['range-trainer', 'gto-simulator'],
  ...
  },
  {
    ...
    relatedLessons: ['l3-bluffing', 'l3-checkraise'],
    relatedModules: ['gto-simulator'],
  ...
  },
  {
    ...
    relatedLessons: ['l4-opponent-reading', 'l4-range-thinking'],
  ...
  },
  {
    ...
    relatedLessons: ['l3-multistreet', 'l7-deepstack', 'l2-short-stack'],
    relatedModules: ['pot-odds'],
