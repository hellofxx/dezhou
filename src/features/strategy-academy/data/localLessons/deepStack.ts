  ...
  // ===== local-deep-suited-connectors =====
  {
    ...
    quiz: [
      ...
      },
      {
        ...
        options: ['所有同花连牌', '54s-9Ts（仅最强）', '不打同花连牌', '32s+'],
        correctIndex: 1,
        explanation: 'UTG 无位置优势，应仅打最强同花连牌（54s-9Ts）。BTN/CO 可以放宽到所有同花连牌。',
      },
      {
        id: 'local-deep-sc-q3',
      ...
      },
      {
        ...
        options: ['30%', '54%（一条街）或 80%（两条街）', '15%', '95%'],
        correctIndex: 1,
        explanation: '15 outs 在翻牌的成牌概率约 54%（一条街）或 80%（两条街），是极强的双重听牌。',
      },
    ],
  },
];
