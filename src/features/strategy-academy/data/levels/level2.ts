        ...
        drillData: {
          questions: [
            ...
            },
            {
              ...
              explanation: 'AK 在 BTN 面对 CO open 是标准 3-Bet。有位置优势，AK 是顶级价值 3-Bet 手牌。IP 3-Bet 标准尺度为 7.5-8BB（约 3-3.5x）。',
              difficulty: 1,
            },
            {
              id: 'd-l2-3bet-q4',
            ...
            {
              id: 'd-l2-3bet-q8',
              scenario: 'NL100, 6-max, 有效筹码 100BB',
              hand: '5s4s',
              position: 'BTN',
              question: 'CO open(2.5BB), 你在 BTN 位持有 54s，应该？',
              options: [
                { id: 'a', text: '弃牌', isCorrect: false },
                { id: 'b', text: '跟注', isCorrect: true },
