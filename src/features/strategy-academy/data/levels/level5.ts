      ...
      },
      {
        ...
        content: [
          ...
          { type: 'heading', content: '短牌策略调整要点' },
          {
            type: 'text',
            content:
              '1. 手牌价值变化：\n   - 连牌（如 JTs, 98s）价值大幅提升（更容易中顺子）\n   - 同花牌价值提升（同花 > 葫芦）\n   - 小口袋对价值下降（set 被顺子 beats）\n   - AK 类型牌价值略降（高牌不再那么强）\n\n2. 翻牌率更高：\n   - 36 张牌意味着更容易翻牌击中\n   - 约 40% 的概率翻牌中至少一对（标准德州约 33%）\n\n3. 更多听牌和 action：\n   - 顺子听牌更常见\n   - 底池通常更大（前注制 + 更多跟注）\n   - 波动更大，资金管理需要更保守',
          },
          { type: 'heading', content: '短牌起手牌范围调整' },
          {
            type: 'text',
            content:
              '短牌范围与标准德州有显著差异：\n\n- JTs 在短牌中是顶级起手牌（约等于标准德州的 AKs）\n- 所有同花连牌价值大幅提升\n- 小口袋对（66-88）价值下降\n- KQo 类型的非同花大牌价值相对下降\n- 范围整体更宽（因为牌组更小，百分比覆盖更广）',
          },
          {
            type: 'pro-tip',
            content:
        ...
        quiz: [
          ...
          {
            id: 'sd-q4',
            question: 'JTs 在短牌中的价值比标准德州？',
            options: ['更低', '相同', '更高', '无法比较'],
            correctIndex: 2,
            explanation: 'JTs 在短牌中价值大幅提升，因为连牌更容易组成顺子，且短牌中翻牌率更高。',
          },
