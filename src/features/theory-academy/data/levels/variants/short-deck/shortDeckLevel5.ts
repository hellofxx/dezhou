    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: 'example',
          content:
            '实例：短牌你持 A♥9♥，翻牌 K♥8♦6♣。你听同花（6 outs）+ A 高。对手下注，你加注半诈唬：对手若弃牌你直接赢底池，若跟注你有同花/高张改进空间。短牌同花价值极高，这个半诈唬的 EV 远高于纯空气。',
        },
        {
          type: 'example',
          content:
            '实例二（挡牌诈唬）：短牌翻牌三张黑桃 K♠9♠6♠，你持 A♠8♦（单张 A♠，无同花）。你阻断了坚果同花 A♠X♠ 全部组合——对手"最强牌"被证伪。此时你加注诈唬代表同花，成功率显著上升。挡牌让同一手"空气"变成不同强度的诈唬。',
        },
        {
          type: 'highlight',
          content:
