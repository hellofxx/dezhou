  ...
  chapters: [
    {
      ...
      content: [
        ...
        },
        {
          type: 'example',
          content:
            '实例二（极化范围）：短牌翻牌 8♥7♥6♠，你（BTN IP）持两对（87）与同花听牌（A♥9♥）。两对下注价值（虽然短牌两对非坚果但强），同花听牌半诈唬。中间牌（如 99）在湿润面 RIO 高，更适合过牌控池。短牌范围极化让对手难以应对。',
        },
        {
          type: 'highlight',
          content:
      ...
      quiz: [
        ...
        },
        {
          ...
          question: '短牌翻牌 8♥7♥6♠，持中间牌（99）的正确做法是：',
          options: [
            '价值下注',
            '过牌控池，湿润面 RIO 高',
            '直接全下',
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: 'example',
          content:
            '实例二（听牌 RIO）：短牌你持 7♥8♥，翻牌 9♦T♣A♠，你听两头顺（6/J），三人池。你的顺子听牌 Outs 在多人池中被"稀释"：若一个对手也听 6/J，你们分池或他成更大顺子。且转牌若对手中两对/三条，你的顺子也可能输给更大的牌。多人池追听要更谨慎。',
        },
        {
          type: 'highlight',
          content:
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: 'example',
          content:
            '实例二（翻前阻断）：短牌你（BB）面对 SB 开池，考虑 3-bet 诈唬。持 A♦6♦ 与 7♦6♦ 的区别：A6s 的 A 阻断对手的 AA 与 AK（顶级强牌变少，被 4Bet 概率下降），且被 4Bet 后 A6s 可干净弃牌；76s 不阻断任何强牌，被 4Bet 时更常撞上 QQ+。短牌中对子密度高，A 高阻断价值更明显。',
        },
        {
          type: 'highlight',
          content:
      ...
      quiz: [
        ...
        {
          id: 't4sd-blockers-q3',
          question: '翻前 3-bet 诈唬，为什么 A5s 优于 76s？',
          options: [
