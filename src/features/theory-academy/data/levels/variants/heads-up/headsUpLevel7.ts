  ...
  chapters: [
    {
      ...
      content: [
        ...
        { type: 'heading', content: '从频率到范围：四个关键维度' },
        {
          type: 'text',
          content:
            '观察单挑对手的四个频率：(1) 翻前开池率——判断他玩多宽；(2) 面对 C-Bet 的弃牌率——判断他是否过度弃牌；(3) 3-bet 率——判断他的攻击性；(4) 摊牌倾向——判断他是跟注站还是可控。这四个频率交叉，基本勾勒出对手的完整画像。样本至少 50-100 手，单手牌印象不作数。',
        },
        {
          type: 'example',
          content:
        ...
        },
        {
          type: 'pro-tip',
          content:
            '建立对手笔记：每 20 手记录一次四个频率（开池率/弃牌率/3-bet 率/摊牌倾向）。单挑高手中"边打边记笔记"是把短期印象转化为长期优势的纪律。',
        },
      ],
      quiz: [
        {
          ...
          correctIndex: 1,
          explanation: '读人是估范围而非猜手牌。从四个关键频率（开池/弃牌/3-bet/摊牌）交叉推断对手画像。',
        },
        {
          id: 't7hu-patterns-q2',
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: 'example',
          content:
            '实例三（何时回基线）：你提高偷盲频率后，对手开始频繁 3-bet 反击——说明他发现了你的偏离。此时必须回到 GTO 基线（收窄偷盲范围、减少纯诈唬），否则你新打开的漏洞会被他反向收割。剥削是动态博弈：偏离-被察觉-回基线，循环往复。',
        },
        {
          type: 'highlight',
          content:
      ...
      quiz: [
        ...
        {
          id: 't7hu-exploit-q5',
          question: '你提高偷盲频率后对手开始频繁 3-bet 反击，正确做法是：',
          options: [
            '继续加大偷盲',
            '回到 GTO 基线，收窄范围',
            '完全停止开池',
